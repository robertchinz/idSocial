function idSocial_auxiliaries_setImageTicks(ax,img_size,edges,wanted_positions)
...
set(ax,'XTick',xtickpos_new{1},'XTickLabel',labelsX);
if numel(edges)==2
    set(ax,'YTick',xtickpos_new{2},'YTickLabel',labelsY)
end
