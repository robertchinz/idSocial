function input_data=idSocial_dynamics_AccelerationMapPolar(input_data,options,plot_mode)

% Map of acceleration strength of a focal individual depending on neighbor
% positions.
%
...
% value of speeding up/decelarating of the focal in each frame is binned 
...
options_new.normalization='density'; % Does not matter for turning maps
