function [turningReact, turningReactInBins, turningReactOneBin]=idSocial_accelerationReactionProbability(tr,spacing,edges,framerate,bodylength,normalize_by_individual_max,rotate_z)
...
for f1=1:no_fish
    for f2=1:no_fish
        if f1~=f2
            ...
            ttt = map_vector.*sign(distance_vector');
            ttt = ttt(~isnan(ttt));
            ...
            map_vector(~isnan(map_vector) & map_vector>0)=1;
            map_vector(~isnan(map_vector) & map_vector<0)=0;
