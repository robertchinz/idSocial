function [turningReact, turningReactInBins, turningReactOneBin]=idSocial_turningReactionProbability(tr,spacing,edges,framerate,bodylength,normalize_by_individual_max,rotate_z)
