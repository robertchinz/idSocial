function varargout=idSocial_attractionMapIndexPolar(trajectory,edges,spacing,framerate,bodylength,discard_percentage_outliers,rotate_z,method,angles_2pi)
