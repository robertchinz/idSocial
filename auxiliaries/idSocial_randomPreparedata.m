function [rand_movementdata rand_trayectorias]=idSocial_randomPreparedata(trayectorias,options, roi)
...
def_options.rand_mode='shuffle_sequences'; %'shuffle_frames'
        ...
        for focal=1:no_fish
            ...
            for nb=1:no_fish
                ...
                if nb~=focal
                    ...
                    temp_md=...
                        idSocial_preparedata(temp_tray,[],[],1,options);
        ...
        for focal=1:no_fish
            for nb=1:no_fish
                ...
                if nb~=focal
                    ...
                    rand_trayectorias(:,focal,nb,:)=trayectorias(randperm(no_frames),nb,:);
                    temp_tray=NaN(no_frames,2,2);
                    temp_tray(:,1,:)=squeeze(rand_trayectorias(:,focal,focal,:));
                    temp_tray(:,2,:)=squeeze(rand_trayectorias(:,focal,nb,:));
                    temp_md=...
